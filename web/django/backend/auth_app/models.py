...
class History(models.Model):
    ...
    playerone = models.CharField(blank=True, null=True)
    playertwo = models.CharField(blank=True, null=True)
    enemyscore = models.IntegerField(blank=True, null=True)
    ownscore = models.IntegerField(blank=True, null=True)
